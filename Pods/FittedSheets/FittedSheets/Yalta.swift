...
extension Anchor where Type: AnchorType.Alignment {
    /// Aligns two anchors.
    //@discardableResult func align<AlignedType: AnchorType.Alignment>(with anchor: Anchor<AlignedType, Axis>, relation: NSLayoutConstraint.Relation = .equal) -> NSLayoutConstraint {
